...
const handleUnitsChange=(e)=>{
  ...
  return (
    ...
    <input type='text' placeholder='Search City...' value={city} onChange={(e)=>setCity(e.target.value)} className='text-xl font-light p-2 w-full shadow-xl focus:outline-none capitalize placeholder:lowercase' />
